...
export default function PhaseAccordionSection({
  ...
  return (
    ...
    >
      <div className="w-full flex items-center gap-3.5 px-5 sm:px-6 py-4 sm:py-5">
        <div className="flex-1 min-w-0 flex items-center gap-3.5 text-left">
          {icon ?? (
            <span
        ...
        {headerRight}
        <button type="button" onClick={onOpenChange} aria-label="Închide faza" className="flex-shrink-0 p-0.5 rounded text-[var(--p-ink-faint)] hover:text-[var(--p-ink)] hover:bg-[var(--p-surface)]">
          <X className="w-4 h-4" />
        </button>
      </div>
      <Collapsible.Content>
